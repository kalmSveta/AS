...
def Recalculate_one_panhandle(lock, df, need_random, title, panhandle_id_mut_info):
    ...
    part1_long, part2_long, seq_long, seq_compl_long, mut_coord_relative = RecalculateEnergies.AddDelitions(
    ...
    seq_long_mutated, seq_compl_long_mutated, part1_long_mutated, part2_long_mutated = RecalculateEnergies.Mutate(
        seq_long, seq_compl_long, mut_coord_relative, mut_seq, mut_to, part1_long, part2_long)
...
def Recalculate_energy_after_mutations(path_to_ph, threads, need_random, title):
...
def main(argv):
    ...
    try:
        ...
        print('RecalculateAfterMutations.py -p <path_to_ph> -t <threads> -r <need_random> -i <title> -m <path_to_mut> -w <path_to_ph_with_mut>')
        sys.exit(2)
    for opt, arg in opts:
        if opt in ('-h', '--help'):
            print('RecalculateAfterMutations.py -p <path_to_ph> -t <threads> -r <need_random> -i <title> -m <path_to_mut> -w <path_to_ph_with_mut>')
